...
CAREER_PATHS = {
    ...
    "Site Reliability Engineer (SRE)": ["Junior SRE", "SRE", "Senior SRE", "Lead SRE", "Staff SRE", "VP Infrastructure"],
...
ROLE_TRANSITIONS = {
    ...
    "DevOps Engineer":           ["Cloud Solutions Architect", "Backend Developer", "Database Administrator", "Site Reliability Engineer (SRE)"],
    "Cybersecurity Analyst":     ["Cloud Solutions Architect", "Database Administrator", "Network Engineer"],
    "Cloud Solutions Architect": ["DevOps Engineer", "Backend Developer", "Site Reliability Engineer (SRE)"],
    ...
    "Site Reliability Engineer (SRE)": ["DevOps Engineer", "Cloud Solutions Architect", "Backend Developer"],
