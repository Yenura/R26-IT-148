% ANONYMIZED SUBMISSION — Double-Blind Compliant (VERIFIED)
% Verified against codebase 2026-09-03: extractor, predictor, feature_engineering, qg_evaluation, interview_scoring, css_engine, train_model, package.json
...
% Double-blind: no authors for review
